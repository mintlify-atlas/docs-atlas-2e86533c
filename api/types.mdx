...
This mapped type transforms an `EnvSchema` into an object with properly typed values. For each key in the schema, it infers the correct TypeScript type based on the schema definition.
...
<ResponseField name="type" type="SchemaType" required>
